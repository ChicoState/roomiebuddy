...
from backend.handler_user import UserHandle
...
def handle_signup() -> Response:
    ...
    try:
        UserHandle().add_user_request(request)
...
def handle_create_group() -> Response:
    ...
    try:
        ...
        response_json = jsonify([{"error_no": "2", "message": str(e)}])
        make_new_log("create_group", e)
        return response_json
...
def handle_leave_group() -> Response:
    ...
    try:
        leave_group(user_id=user_id, group_id=group_id, password=password)
    except Exception as e:
        response_json = jsonify([{"error_no": "2", "message": str(e)}])
        make_new_log("leave_group", e)
        return response_json
...
def handle_delete_group() -> Response:
    ...
    try:
        delete_group(user_id=user_id, group_id=group_id, password=password)
    except Exception as e:
        response_json = jsonify([{"error_no": "2", "message": str(e)}])
        make_new_log("delete_group", e)
        return response_json
    ...
    response_json = jsonify(
        [{"error_no": "0", "message": "Successfully deleted group"}]
    )
    return response_json
...
def handle_invite_to_group() -> Response:
    ...
    try:
        ...
        invite_id: str = invite_user_to_group(
            inviter_id=inviter_id, invitee_id=invitee_id, group_id=group_id
        )
    except Exception as e:
        response_json = jsonify([{"error_no": "2", "message": str(e)}])
        make_new_log("invite_to_group", e)
...
def handle_respond_to_invite() -> Response:
    ...
    try:
        respond_to_invite(
            user_id=user_id, invite_id=invite_id, status=status, password=password
        )
    except Exception as e:
        response_json = jsonify([{"error_no": "2", "message": str(e)}])
        make_new_log("respond_to_invite", e)
    ...
    response_json = jsonify(
        [{"error_no": "0", "message": f"Successfully {status} invitation"}]
    )
    return response_json
